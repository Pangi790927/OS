...
namespace std
{
	...
	string to_string (int value, int mod = 10);
	string to_string (long value, int mod = 10);
	string to_string (long long value, int mod = 10);
	string to_string (unsigned value, int mod = 10);
	string to_string (unsigned long value, int mod = 10);
	string to_string (unsigned long long value, int mod = 10);
	string to_string (float value, int mod = 10);
	string to_string (double value, int mod = 10);
	string to_string (long double value, int mod = 10);
